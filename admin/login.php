...
<div class="brand-panel">
  ...
  <div class="brand-mid">
    <span class="role-tag"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" style="margin-right:2px"><circle cx="12" cy="8" r="4"/><path d="M4 21c0-4 3.6-6 8-6s8 2 8 6"/></svg>Admin Portal</span>
    <h1>Run placements with full control.</h1>
    <p>Manage companies, drives, departments, staff and students — all from a single dashboard.</p>
    <ul class="feature-list">
      <li><span class="dot"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><polyline points="20 6 9 17 4 12"/></svg></span>Create &amp; manage companies and drives</li>
      <li><span class="dot"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><polyline points="20 6 9 17 4 12"/></svg></span>Approve student verification requests</li>
      <li><span class="dot"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><polyline points="20 6 9 17 4 12"/></svg></span>Full analytics &amp; reporting suite</li>
    </ul>
  </div>
...
<div class="form-panel">
  <div class="form-shell">
    ...
    <div class="form-card">
      <h2>Admin sign in</h2>
      <p class="lead">Restricted access — authorized personnel only.</p>
      ...
      <form method="POST" class="login-form" id="loginForm">
        ...
        <div class="field">
          ...
          <div class="field-wrap">
            <input type="email" id="email" name="email" placeholder="admin@college.edu" required autocomplete="email" value="<?= htmlspecialchars($_POST['email'] ?? '') ?>">
