...
<div class="container">
    <div class="page-header">
        <a href="departments.php" class="btn btn-secondary" style="margin-bottom:1rem;">← Back to Departments</a>
        ...
        <div class="profile-top">
            ...
            <div class="profile-info">
                ...
                <div class="d-flex gap-1 flex-wrap" style="margin-top:0.5rem;">
                    ...
                    <span class="badge badge-info">Current CGPA: <?= number_format($student['cgpa'], 2) ?><?php if ($averageCgpa): ?> (Overall Avg: <?= number_format($averageCgpa, 2) ?>)<?php endif; ?></span>
    ...
    <div class="card">
        ...
        <div style="padding:1.5rem;display:grid;grid-template-columns:repeat(auto-fit,minmax(250px,1fr));gap:1.5rem;">
            ...
            <div>
                ...
                <?= number_format($student['cgpa'], 2) ?><?php if ($averageCgpa): ?> (Average: <?= number_format($averageCgpa, 2) ?>)<?php endif; ?>
            </div>
            <div>
        ...
        <div style="padding:1.5rem;display:grid;grid-template-columns:repeat(auto-fit,minmax(250px,1fr));gap:1.5rem;">
            <div>
                ...
                <?php if ($student['github_link']): ?>
                    <a href="<?= htmlspecialchars($student['github_link']) ?>" target="_blank" style="color: var(--primary); text-decoration: none;">View Profile ↗</a>
                <?php else: ?>
                    N/A
                <?php endif; ?>
            </div>
            <div>
                ...
                <?php if ($student['linkedin_link']): ?>
                    <a href="<?= htmlspecialchars($student['linkedin_link']) ?>" target="_blank" style="color: var(--primary); text-decoration: none;">View Profile ↗</a>
                <?php else: ?>
                    N/A
                <?php endif; ?>
            </div>
