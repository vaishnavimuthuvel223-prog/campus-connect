...
<title>Staff Login - Campus Connect</title>
...
<div class="brand-panel">
  ...
  <div class="brand-mid">
    <span class="role-tag"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" style="margin-right:2px"><circle cx="12" cy="8" r="4"/><path d="M4 21c0-4 3.6-6 8-6s8 2 8 6"/></svg>Staff Portal</span>
    <h1>Guide your students to placement success.</h1>
    <p>Review applications, verify eligibility, and approve student drives for your department.</p>
    <ul class="feature-list">
      <li><span class="dot"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><polyline points="20 6 9 17 4 12"/></svg></span>Approve or reject student applications</li>
      <li><span class="dot"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><polyline points="20 6 9 17 4 12"/></svg></span>Monitor department-wise placement stats</li>
      <li><span class="dot"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><polyline points="20 6 9 17 4 12"/></svg></span>Send notifications &amp; announcements</li>
    </ul>
  </div>
...
<div class="form-panel">
  <div class="form-shell">
    ...
    <div class="form-card">
      <h2>Staff sign in</h2>
      <p class="lead">Enter your Staff ID and password to continue.</p>
      ...
      <form method="POST" class="login-form" id="loginForm">
        ...
        <div class="field">
          ...
          <div class="field-wrap">
            <input type="text" id="staff_id" name="staff_id" placeholder="e.g. CSE-001" required autocomplete="username" value="<?= htmlspecialchars($_POST['staff_id'] ?? '') ?>">
            <span class="field-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="16" rx="2"/><circle cx="9" cy="10" r="2"/><path d="M15 8h3M15 12h3M6 16h12"/></svg></span>
          </div>
        </div>
        <div class="field">
      ...
      <div class="form-footer">
        <p>New staff member? <a href="register.php">Register here</a></p>
